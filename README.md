# App Reflection – Weight Tracking App
...
I tested the app by entering different weight values, checking that they saved correctly, and confirming that past entries displayed properly. I also tested edge cases, such as empty inputs. Testing is important because even small mistakes—like data not saving correctly—would make the app unreliable. 

One challenge was making sure the app stayed simple while still functioning correctly. Since the app only tracks weight, I had to make sure the storage and display features worked smoothly and clearly showed progress over time. The part I am most proud of is the weight logging and history display feature, because it demonstrates my understanding of handling user input, storing data, and displaying that data back to the user in a meaningful way.
